...
public class WordsDAO {
    ...
    public List<SynAnt> getListSynAntByWord(String word){
        return (List<SynAnt>) em.createQuery("select distinct wd.synAntList, wd.synAntList from Words wd where wd.word = :word")
...
//    }
    ...
    public List<SynAnt> getListDependSynAntByWord(String word){
        return (List<SynAnt>) em.createQuery("select distinct wd.synAntCollection1, wd.synAntList from Words wd where wd.word = :word")
                .setParameter("word", word)
                .getResultList();
//                .getResultList();
